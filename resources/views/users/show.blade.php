...
@section('content')
    <h1 class="text-center text-5xl" style="margin-top: 5rem;color:rgb(255, 255, 255); font-weight:bold;">USER DETAILS</h1>
        ...
        <div class="flex justify-center items-center max-h-screen" style="margin-top:20px">
            <div class="relative p-4 w-full max-w-xl max-h-full">
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <dl>
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">User Name</dt>
