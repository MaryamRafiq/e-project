...
@section('content')
    <h1 class="text-center text-5xl" style="margin-top: 5rem; color:rgb(255, 255, 255); font-weight:bold">ALL USERS</h1>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            <a href="/users/create" class="text-white hover:text-white">Add User</a>
                        </button>
                    </div>
                </div>
