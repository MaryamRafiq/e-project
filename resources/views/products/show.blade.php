...
@section('content')
    <h1 class="text-center text-5xl" style="margin-top: 5rem;color:rgb(255, 255, 255); font-weight:bold;">PRODUCT DETAILS</h1>
        ...
        <div class="flex justify-center items-center max-h-screen" style="margin-top:20px">
            <div class="relative p-4 w-full max-w-xl max-h-full">
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <dl>
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Product Name</dt>
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $product->name }}</dd>
                    ...
                    <dl>
                        ...
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $product->price }}</dd>
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Quantity</dt>
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $product->quantity }}</dd>
                    </dl>

                    <dl>
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Category</dt>
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $product->category_id }}</dd>
                        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Image</dt>
                        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $product->image }}</dd>
                    </dl>
