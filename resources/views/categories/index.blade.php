...
@section('content')
    <h1 class="text-center text-5xl" style="margin-top: 5rem; color:rgb(255, 255, 255); font-weight:bold">ALL CATEGORIES</h1>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    <div class="w-full md:w-1/2">
                        <form action="{{ route('categories.index') }}" method="GET" class="flex items-center space-x-4">
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            <a href="/categories/create" class="text-white hover:text-white">Add Category</a>
                        </button>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-4 py-3 text-center">No categories found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
